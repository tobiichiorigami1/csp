...
def inception_v3_arg_scope(weight_decay=0.00004
    ...
    batch_normalization_parameters={'decay':0.9997,
                                    'epsilon':0.001,
                                    'updates_collecions':tf.GraphKeys.UPDATE_OPS,
                                    variable_collections:{'beta':None,
                                                          'gamma':None,
    ...
    with slim.arg_scope([slim.conv2d,slim.fully_connected],
        ...
        with slim.arg_scope(
            [slim.conv2d],
            weights_initializer=tf.truncted_normal_initializer(stddev=stddev),
...
def inception_v3_base(inputs,scope=None):
    ...
    with tf.variable_scope(scope,'InceptionV3',[inputs]):
        ...
        with slim.arg_scope([slim.conv2d,slim.maxpool2d,slim.avg_pool2d],
            ...
            with tf.variable_scope('Mixed_5b'):
                ...
                with tf.variable_scope('Branch_3'):
                    branch_3 = slim.avg_pool2d(net,32,[3,3],scope='AvgPool_0a_3x3')
...
def inception_v3(inputs,
    ...
    with tf.variable_scope(scope,'InceptionV3',[inputs,num_classes],
        ...
        with slim.arg_scope(scope,'InceptionV3',[inputs,num_classes],
                            reuse=reuse) as scope:
            ...
            with slim.arg_scope([slim.conv2d,slim.max_pool2d,slim.avg_pool2d],
                ...
                with tf.variable_scope('AuxLogits'):
                    ...
                    aux_logits = slim.conv2d（
                        aux_logitss,num_classes,[1,1],activation_fn=None,
...
with slim.arg_scope(incetion_v3_arg_scope()):
